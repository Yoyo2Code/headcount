...
class EnrollmentTest < Minitest::Test
  ...
  def test_kindergarten_participation_in_year
    ...
    data = e.kindergarten_participation_in_year(2010)
    assert_equal 0.391, data
  end

  def test_kindergarten_participation_in_unknown_year_returns_nil
    e = Enrollment.new({
      :name => "ACADEMY 20",
      :kindergarten_participation => { 2010 => 0.3915,
                                       2011 => 0.35356,
    ...
    data = e.kindergarten_participation_in_year(1987)
  ...
  def test_graduation_rate_in_year
    ...
    data = e.graduation_rate_in_year(2012)
    assert_equal 0.889, data
  end
  ...
  def test_graduation_rate_in_unknown_year_returns_nil
    ...
    data = e.graduation_rate_in_year(1987)
    assert_equal nil, data
  end
end

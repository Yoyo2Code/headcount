# HeadCount
__Created by: Garrett Smestad & Yoseph Anderson__
...
The list of files that are relevant to each data "category" are listed below. You'll find the data files in the `data` folder of the repository.
